...
```{r}
all_B1_1 <- mainPipeline(4, save=FALSE, clock=TRUE, gender_state=1)
```


```{r}
all_B1_2 <- mainPipeline(5, save=FALSE, clock=TRUE, gender_state=1)
```

```{r}
all_B1_3 <- mainPipeline(6, save=FALSE, clock=TRUE, gender_state=1)
```
...
```{r}
all_B3_1 <- mainPipeline(4, save=FALSE, clock=FALSE, gender_state=2)
```

```{r}
all_B4_1 <- mainPipeline(4, save=FALSE, clock=FALSE, gender_state=3)
```
